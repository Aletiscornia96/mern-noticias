                ...
                <>
                    <Table hoverable className="shadow-md">
                        ...
                        <Table.Body className='divide-y'>
                            {users.map((user) => (
                                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800' key={user._id}> {/* Asegúrate de tener una clave única */}
                                    <Table.Cell>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
                ...
                <Modal.Body>
                    <div className="text-center gap-4">
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Esta segudo que desea elimar este usuario?</h3>
