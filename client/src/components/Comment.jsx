...
export default function Comment({ comment, onLike, onEdit, onDelete }) {
    ...
    return (
        <div className='flex p-4 border-b dark:border-gray6-- text-sm'>
            ...
            <div className='flex-1'>
                ...
                {isEditing ? (
                    ...
                    <>
                        <p className='text-gray-500 pb-2'>{comment.content}</p><div className='flex items-center pt-2 text-xs border-t dark:border0gray-700 max-w-fit gap-2'>
